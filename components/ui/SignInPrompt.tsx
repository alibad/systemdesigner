...
export default function SignInPrompt({
  ...
  description = "Create, save, and share your work.",
  icon
}: SignInPromptProps) {
  ...
  return (
    <div className="text-center py-8 md:py-16 px-4">
      ...
      <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-3">{title}</h2>
      <p className="text-neutral-600 dark:text-neutral-400 mb-8">{description}</p>
