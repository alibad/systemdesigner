...
Last reviewed: September 4, 2026. These are priorities, not promised release dates. Every implemented milestone below, including the 130-day guided journey and hand-authored practice for all 202 lessons, is deployed to SystemDesigner.net (release `dd26a9bd`); live guest checks passed. The remaining product and validation work is described below.
