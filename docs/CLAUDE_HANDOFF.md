...
- The guided journey now covers **all 264 sessions across 317 study days in 14 parts**, with 53 review days (106 review tasks) and 25 milestones. Parts six to ten add GenAI, parts eleven to fourteen add ML. Day IDs are unchanged, so learners mid-journey keep their tasks. The end-of-journey screen no longer hands off to the GenAI and ML course pages, because both are now on the path.
