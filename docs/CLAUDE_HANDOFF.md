...
- Mixed practice in all 202 lesson sessions. **72 hand-authored packs** contain 311 groups and 933 variants and cover every system-design lesson plus selected GenAI and ML lessons (calculations, ordered protocols, scenario decisions checked against the lesson sources). **130 source-derived packs**, all GenAI and ML, reuse existing responsibilities and source questions, with section-specific prompts, non-revealing hints, and per-part explanations. Combined: **831 groups, 2,208 variants**. These are not 2,208 newly written or independently reviewed exercises.
