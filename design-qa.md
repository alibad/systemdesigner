...
Logs and captures: `.artifacts/journey-continuation/` (suite logs, build log, simulator captures) and `.artifacts/learning-journey/` (phone and desktop screenshots from the journey suite).
